...
var enText = map[string]string{
	...
	"why_clear":                  "   No risk list connection was found and almost all of the money could be followed to named services. Nothing here suggests the funds are tainted.\n",
	"why_caution":                "   No direct link to a risk list, so not high risk. But it cannot be called clean: %s. Verify the counterparty before sending a large amount.\n",
	"why_high_risk":              "   High risk because %s. Do not send or accept funds without further checks.\n",
...
var trText = map[string]string{
	...
	"why_clear":                  "   Hiçbir risk listesiyle bağlantı bulunmadı ve paranın neredeyse tamamı kimliği bilinen hizmetlere kadar izlendi. Fonların kirli olduğuna dair bir işaret yok.\n",
	"why_caution":                "   Risk listeleriyle doğrudan bağlantı yok, bu yüzden Riskli değil. Ama Temiz de denemez: %s. Büyük tutar göndermeden önce karşı tarafı doğrulayın.\n",
