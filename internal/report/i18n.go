...
var enText = map[string]string{
	...
	"why_own_service":            "   Not risky: this wallet belongs to %s (%s), so its many unknown counterparties are that service's customers.\n",
	...
	// --- PDF report (D36) ---
	"pdf_title":            "Address Risk Screening",
	"pdf_subtitle":         "Triage report - not a regulated AML determination",
	"pdf_chain":            "Chain: %s",
	"pdf_exposure_band":    "EXPOSURE %s",
	"pdf_exposure_score":   "Exposure score %s / 100",
	"pdf_coverage":         "Coverage %s",
	"pdf_listed_title":     "THIS ADDRESS IS DIRECTLY LISTED",
	"pdf_listed_body":      "%s - category: %s, source: %s (confidence %s). This is a direct listing, not exposure traced through other addresses.%s",
	"pdf_conflict":         " Sources disagree about this address; the conflict is recorded for review.",
	"pdf_direct_listing":   "DIRECT LISTING: %s",
	"pdf_band_forced":      "%s. The band is set to High regardless of the computed score.",
	"pdf_sanctions_title":  "DIRECT SANCTIONS MATCH",
	"pdf_sanctions_body":   "This address appears on a sanctions list. The band is set to High regardless of the computed score.",
	"pdf_lowconf_title":    "LOW CONFIDENCE - READ BEFORE USING",
	"pdf_lowconf_body":     "Only %s of traced value could be attributed to a known entity. The score describes that portion only. The remaining %s is unknown, not clean, and this report makes no claim about it.",
	"pdf_capped_title":     "BAND CAPPED",
	"pdf_capped_body":      "The only evidence for this address is unverified community abuse reports. The band is capped accordingly and should not be read as a cleared result.",
	"pdf_inbound":          "INBOUND - where funds came from",
	"pdf_outbound":         "OUTBOUND - where funds went",
	"pdf_no_value":         "No traced value in this direction.",
	"pdf_col_category":     " Category",
	"pdf_col_share":        "Share",
	"pdf_col_weight":       "Weight",
	"pdf_col_contribution": "Contribution to score",
	"pdf_unattributed":     " Unattributed",
	"pdf_not_scored":       "not scored - unknown",
	"pdf_note":             " Note: %s",
	"pdf_fanout":           "neighbour cap reached; this traversal is truncated",
	"pdf_hoplimit":         "hop limit reached; value beyond it is unknown",
	"pdf_paths":            "TOP CONTRIBUTING PATHS",
	"pdf_path":             "%s via %d hop(s) - %s - contributes %s",
	"pdf_dir_in":           "in",
	"pdf_dir_out":          "out",
	"pdf_no_paths":         "No path reached an identified counterparty. This is a coverage gap, not an absence of activity: flows were traced but could not be attributed to a named entity.",
	"pdf_generated":        "Generated %s   |   Label snapshot %d   |   Config version %s",
	"pdf_methodology":      "Methodology: docs/METHODOLOGY.md",
	"pdf_disclaimer":       "This report is automated triage and pre-screening built on open data. It is not a regulated AML determination, does not constitute advice, and must not be used as the sole basis for any decision about a person or account. Every figure is reconstructible from the stored path set identified by the run details above.",
}
...
var trText = map[string]string{
	...
	"why_own_service":            "   Riskli değil: bu cüzdan %s hizmetine ait (%s); bilinmeyen çok sayıdaki karşı tarafı o hizmetin müşterileri.\n",
	...
	// --- PDF report (D36) ---
	"pdf_title":            "Adres Risk Taraması",
	"pdf_subtitle":         "Ön tarama raporu - düzenlenmiş bir AML kararı değildir",
	"pdf_chain":            "Ağ: %s",
	"pdf_exposure_band":    "MARUZİYET %s",
	"pdf_exposure_score":   "Maruziyet puanı %s / 100",
	"pdf_coverage":         "Kapsam %s",
	"pdf_listed_title":     "BU ADRES DOĞRUDAN LİSTEDE",
	"pdf_listed_body":      "%s - kategori: %s, kaynak: %s (güven %s). Bu, başka adresler üzerinden izlenen bir maruziyet değil, doğrudan bir listelemedir.%s",
	"pdf_conflict":         " Kaynaklar bu adres hakkında farklı görüşte; çelişki inceleme için kaydedildi.",
	"pdf_direct_listing":   "DOĞRUDAN LİSTELEME: %s",
	"pdf_band_forced":      "%s. Hesaplanan puandan bağımsız olarak seviye Yüksek'e ayarlandı.",
	"pdf_sanctions_title":  "DOĞRUDAN YAPTIRIM EŞLEŞMESİ",
	"pdf_sanctions_body":   "Bu adres bir yaptırım listesinde yer alıyor. Hesaplanan puandan bağımsız olarak seviye Yüksek'e ayarlandı.",
	"pdf_lowconf_title":    "DÜŞÜK GÜVEN - KULLANMADAN ÖNCE OKUYUN",
	"pdf_lowconf_body":     "İzlenen değerin yalnızca %s kadarı bilinen bir kuruluşa bağlanabildi. Puan yalnızca bu kısmı anlatır. Kalan %s bilinmiyor, temiz değil; bu rapor onun hakkında bir şey söylemez.",
	"pdf_capped_title":     "SEVİYE SINIRLANDI",
	"pdf_capped_body":      "Bu adres için tek kanıt doğrulanmamış topluluk kötüye kullanım bildirimleri. Seviye buna göre sınırlandı; temiz sonuç olarak okunmamalı.",
	"pdf_inbound":          "GELEN - fonların geldiği yer",
	"pdf_outbound":         "GİDEN - fonların gittiği yer",
	"pdf_no_value":         "Bu yönde izlenen değer yok.",
	"pdf_col_category":     " Kategori",
	"pdf_col_share":        "Pay",
	"pdf_col_weight":       "Ağırlık",
	"pdf_col_contribution": "Puana katkı",
	"pdf_unattributed":     " Atfedilemeyen",
	"pdf_not_scored":       "puanlanmadı - bilinmiyor",
	"pdf_note":             " Not: %s",
	"pdf_fanout":           "komşu sınırına ulaşıldı; bu izleme kesildi",
	"pdf_hoplimit":         "adım sınırına ulaşıldı; ötesindeki değer bilinmiyor",
	"pdf_paths":            "EN ÇOK KATKI YAPAN YOLLAR",
	"pdf_path":             "%s, %d adım - %s - katkı %s",
	"pdf_dir_in":           "gelen",
	"pdf_dir_out":          "giden",
	"pdf_no_paths":         "Hiçbir yol tanımlı bir karşı tarafa ulaşmadı. Bu bir kapsam boşluğudur, faaliyet yokluğu değil: akışlar izlendi ama adı bilinen bir kuruluşa bağlanamadı.",
	"pdf_generated":        "Oluşturulma %s   |   Etiket anlık görüntüsü %d   |   Yapılandırma sürümü %s",
	"pdf_methodology":      "Yöntem: docs/METHODOLOGY.md",
	"pdf_disclaimer":       "Bu rapor, açık verilere dayalı otomatik bir ön taramadır. Düzenlenmiş bir AML kararı değildir, tavsiye niteliği taşımaz ve bir kişi ya da hesap hakkında verilecek hiçbir kararın tek dayanağı olarak kullanılmamalıdır. Her rakam, yukarıdaki çalışma bilgileriyle belirlenen saklı yol kümesinden yeniden üretilebilir.",
}
...
var ruText = map[string]string{
	...
	"why_own_service":            "   Нет риска: кошелёк принадлежит %s (%s), поэтому его многочисленные неизвестные контрагенты — клиенты этого сервиса.\n",
	...
	// --- PDF report (D36) ---
	"pdf_title":            "Проверка адреса на риск",
	"pdf_subtitle":         "Отчёт предварительной проверки — не регулируемое AML-заключение",
	"pdf_chain":            "Сеть: %s",
	"pdf_exposure_band":    "ЭКСПОЗИЦИЯ: %s",
	"pdf_exposure_score":   "Балл экспозиции %s / 100",
	"pdf_coverage":         "Покрытие %s",
	"pdf_listed_title":     "АДРЕС НАПРЯМУЮ ВНЕСЁН В СПИСОК",
	"pdf_listed_body":      "%s — категория: %s, источник: %s (уверенность %s). Это прямое внесение в список, а не экспозиция через другие адреса.%s",
	"pdf_conflict":         " Источники расходятся в оценке этого адреса; расхождение записано для проверки.",
	"pdf_direct_listing":   "ПРЯМОЕ ВНЕСЕНИЕ В СПИСОК: %s",
	"pdf_band_forced":      "%s. Уровень установлен как высокий независимо от рассчитанного балла.",
	"pdf_sanctions_title":  "ПРЯМОЕ СОВПАДЕНИЕ С САНКЦИОННЫМ СПИСКОМ",
	"pdf_sanctions_body":   "Этот адрес есть в санкционном списке. Уровень установлен как высокий независимо от рассчитанного балла.",
	"pdf_lowconf_title":    "НИЗКАЯ УВЕРЕННОСТЬ — ПРОЧТИТЕ ПЕРЕД ИСПОЛЬЗОВАНИЕМ",
	"pdf_lowconf_body":     "Лишь %s отслеженной стоимости удалось отнести к известным участникам. Балл описывает только эту часть. Остальные %s неизвестны — это не значит «чисто», и отчёт ничего о них не утверждает.",
	"pdf_capped_title":     "УРОВЕНЬ ОГРАНИЧЕН",
	"pdf_capped_body":      "Единственное основание по этому адресу — непроверенные жалобы сообщества. Уровень ограничен и не должен считаться подтверждением чистоты.",
	"pdf_inbound":          "ВХОДЯЩИЕ — откуда пришли средства",
	"pdf_outbound":         "ИСХОДЯЩИЕ — куда ушли средства",
	"pdf_no_value":         "В этом направлении отслеженной стоимости нет.",
	"pdf_col_category":     " Категория",
	"pdf_col_share":        "Доля",
	"pdf_col_weight":       "Вес",
	"pdf_col_contribution": "Вклад в балл",
	"pdf_unattributed":     " Не атрибутировано",
	"pdf_not_scored":       "не оценено — неизвестно",
	"pdf_note":             " Примечание: %s",
	"pdf_fanout":           "достигнут лимит соседей; обход усечён",
	"pdf_hoplimit":         "достигнут лимит шагов; стоимость за ним неизвестна",
	"pdf_paths":            "ОСНОВНЫЕ ПУТИ",
	"pdf_path":             "%s, шагов: %d — %s — вклад %s",
	"pdf_dir_in":           "вх.",
	"pdf_dir_out":          "исх.",
	"pdf_no_paths":         "Ни один путь не дошёл до известного контрагента. Это пробел в покрытии, а не отсутствие активности: потоки отслежены, но не отнесены к известному участнику.",
	"pdf_generated":        "Создан %s   |   Снимок меток %d   |   Версия конфигурации %s",
	"pdf_methodology":      "Методология: docs/METHODOLOGY.md",
	"pdf_disclaimer":       "Этот отчёт — автоматическая предварительная проверка по открытым данным. Он не является регулируемым AML-заключением, не является рекомендацией и не должен служить единственным основанием для решения о лице или счёте. Каждое значение можно воспроизвести по сохранённому набору путей, указанному в данных прогона выше.",
}
